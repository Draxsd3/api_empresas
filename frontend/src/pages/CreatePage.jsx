...
function CreatePage() {
  ...
  return /* @__PURE__ */ jsxDEV("section", { className: "main", children: [
    /* @__PURE__ */ jsxDEV("div", { className: "header", children: [
      ...
      state.loading && /* @__PURE__ */ jsxDEV("div", { className: "status", children: "Salvando..." }, void 0, false, {
        fileName: "<stdin>",
        lineNumber: 52,
        columnNumber: 27
      }, this)
    ...
    /* @__PURE__ */ jsxDEV("div", { className: "card", children: /* @__PURE__ */ jsxDEV("form", { onSubmit, children: [
      ...
      /* @__PURE__ */ jsxDEV("div", { className: "row", children: [
        ...
        /* @__PURE__ */ jsxDEV("button", { className: "btn", type: "submit", disabled: state.loading, children: "Salvar Empresa" }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 99,
          columnNumber: 13
        }, this)
      ...
      state.error && /* @__PURE__ */ jsxDEV("p", { style: { marginTop: "16px", padding: "12px 16px", background: "var(--error-light)", color: "var(--error)", borderRadius: "var(--radius-md)", fontSize: "14px", fontWeight: "500" }, children: state.error }, void 0, false, {
        fileName: "<stdin>",
        lineNumber: 101,
        columnNumber: 27
      }, this),
      state.data && /* @__PURE__ */ jsxDEV("p", { style: { marginTop: "16px", padding: "12px 16px", background: "var(--success-light)", color: "var(--success)", borderRadius: "var(--radius-md)", fontSize: "14px", fontWeight: "500" }, children: "\u2713 Empresa salva com sucesso!" }, void 0, false, {
        fileName: "<stdin>",
        lineNumber: 102,
        columnNumber: 26
      }, this)
